...
declare module "excel4node" {
    ...
    class Worksheet {
         ...
         */
        addDataValidation(opt: WorksheetValidation): DataValidation
        /**
         ...
         */
        addConditionalFormattingRule(ref: string, opt: AddConditionalFormattingRuleOptions): Worksheet
         ...
         */
        addImage(opt: AddImageOptions): Drawing
    }
    /**
    ...
    export class Workbook {
         ...
         */
        write(filename: string, callback?: (err: never, stats: Stats) => void): void
